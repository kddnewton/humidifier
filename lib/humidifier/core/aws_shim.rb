require 'humidifier/core/aws_adapters/base'
require 'humidifier/core/aws_adapters/noop'
require 'humidifier/core/aws_adapters/sdkv1'
require 'humidifier/core/aws_adapters/sdkv2'
